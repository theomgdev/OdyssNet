...
*   **Adım sayısı bir kadrandır:** sabit ızgarada değildir — ağırlıklar tek bir kadansa göre oturur ve sadakat 6 adımda %97.2 iken 64 adımda %68.8'e düşer. Adım sayısını her batch'te çekmek (`--k-range`, artık 12–20 ile varsayılan) bu yayılımı bir tohumda 42.8'den 14.8'e, diğerinde 45.4'ten 10.4'e indirir ve Fréchet mesafesini düz tutar. 12–20 aralığında eğitilmesine rağmen aralığın iki yanında, K=4 ve K=64'te de tutar: öğrendiği şey gördüğü aralık değil, kadansın okunacak bir büyüklük olduğudur. Bkz. `--mode flex`.
