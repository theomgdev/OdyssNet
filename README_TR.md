...
*   **Bir kadran olarak adım sayısı:** eğitim ızgarası örnekleme ızgarası olduğu için ağırlıklar tek bir kadansa göre oturuyor — sadakat 6 adımda %97.2 iken 64 adımda %68.8'e düşüyor. `--k-range 12,20` adım sayısını her batch'te çekerek bu yayılımı 42.8 puandan 14.8'e indiriyor ve Fréchet mesafesini düz tutuyor; `--cadence` her kareye atacağı adımın büyüklüğünü söyleyerek her adım sayısında sadakati yükseltiyor, bedelini örnek dağılımından ödüyor. İkisi de varsayılan olarak kapalı. Bkz. `--mode flex`.
